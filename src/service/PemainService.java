...
import database.ServiceDatabase; // ← Ganti ini
...
public class PemainService {
    ...
    public void tambahPemain() {
        ...
        if (jenis.equals("1")) {
            ...
            PemainSenior pemainSenior = new PemainSenior(nama, klub, posisi, nomorPunggung, usia, penghargaan);
            pemainList.add(pemainSenior);
            ...
            PemainAkademi pemainAkademi = new PemainAkademi(nama, klub, posisi, nomorPunggung, usia, akademi, tahunMasuk);
            pemainList.add(pemainAkademi);
        }
